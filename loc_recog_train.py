...
tf.app.flags.DEFINE_integer('back_side', 0, '')
...
# tf.app.flags.DEFINE_string('pretrained_model_path', '/media/ee303/backup/FastROR_backup/weight_backup/single_blister_checkpoints/0514_back_loc/', '')
tf.app.flags.DEFINE_string('pretrained_model_path', '/ee303/FastROR_single/pretrain/resnet_v1_50.ckpt', '')
tf.app.flags.DEFINE_integer('train_stage', 1, '0-train detection only; 1-train recognition only; 2-train end-to-end; 3-train end-to-end absolutely')
tf.app.flags.DEFINE_string('training_data_dir', default='/ee303/FastROR_single/datasets/PS1_PS2_single_dataset/front/train/JPEGImages/', help='training images dir')
tf.app.flags.DEFINE_string('training_gt_data_dir', default='/ee303/FastROR_single/datasets/PS1_PS2_single_dataset/front/train/Annotations/', help='training gt dir')
