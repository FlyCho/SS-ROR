...
# tf.app.flags.DEFINE_string('test_data_path', '/ee303/FastROR_single/datasets/New_PS3/front/JPEGImages/', '')
# tf.app.flags.DEFINE_string('test_gt_path', '/ee303/FastROR_single/datasets/New_PS3/front/Annotations/', '')
tf.app.flags.DEFINE_string('test_data_path', '/ee303/FastROR_single/datasets/PS3/front/JPEGImages/', '')
tf.app.flags.DEFINE_string('test_gt_path', '/ee303/FastROR_single/datasets/PS3/front/Annotations/', '')
tf.app.flags.DEFINE_string('gpu_list', '0', '')
tf.app.flags.DEFINE_string('checkpoint_path', '/media/ee303/backup/FastROR_backup/weight_backup/single_blister_checkpoints/0519_front_loc_recog/', '')
            ...
            for w in range(0, weight_len):
                ...
                print(
                    "weight: {} || accuracy:{:.4f}, precision:{:.4f}, recall:{:.4f}, f1_score:{:.4f}, IoU:{:.4f}, FPS:{:.6f} \n".format(
                        (2500 * (w + 1)), accuracy, precision, recall, F1_score, average_iou, 1/average_time))
