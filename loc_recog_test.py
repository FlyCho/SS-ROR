...
tf.app.flags.DEFINE_string('test_data_path',
                           'D:/FOTS/datasets/PS1_PS2_paired_vertical_dataset/test/JPEGImages/', '')
tf.app.flags.DEFINE_string('test_gt_path',
                           'D:/FOTS/datasets/PS1_PS2_paired_vertical_dataset/test/Annotations/',
                           '')
# tf.app.flags.DEFINE_string('test_data_path', 'D:/FOTS/FOTS_TF-dev/datasets/tf3_dataset/test/JPEGImages/', '')
tf.app.flags.DEFINE_string('gpu_list', '0', '')
tf.app.flags.DEFINE_string('checkpoint_path', 'E:/FastROR/checkpoints/loc_recog_systh100k_0324/', '')
    ...
    with tf.get_default_graph().as_default():
        ...
        with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as sess:
            ...
            for im_fn in im_fn_list:
                ...
                # four points is from ground_truth
                # ########################################################################################################
                ...
                if boxes is not None and boxes.shape[0] != 0:
                    ...
                    if input_roi_boxes.shape[0] == 2:
                        ...
                        print("ground-truth:[{}] predict result:{}".format(im_gt, im_pred))
                        count += 1
